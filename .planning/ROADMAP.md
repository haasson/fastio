...
- [ ] **Phase 1: Security Foundation** — Закрыть дыры в изоляции тенантов и утечке ключей до любой другой работы
...
**Success Criteria** (what must be TRUE):
  ...
  4. Staging and production Supabase projects are separate; a developer cannot accidentally run E2E tests against the production database

**Plans:** 4 plans
Plans:
**Wave 1**

- [ ] 01-01-PLAN.md — SEC-03 tenant middleware hardening (Host guard + 503 for unknown tenant + 500 for missing tenantId in getTenantDb)
- [ ] 01-02-PLAN.md — SEC-02 CI security job: grep storefront public bundle for service_role
- [ ] 01-03-PLAN.md — SEC-01 migration 302 (RLS on edge_alerts_state) + migrate.yml TENANT_TABLES audit query

**Wave 2** *(blocked on Wave 1 completion)*

- [ ] 01-04-PLAN.md — SEC-04 staging Supabase Cloud project + migrate.yml staging push + minimal E2E seed + global-setup.mjs branching
