...
- [ ] **INFRA-01**: Ops Server — отдельный Nuxt/Nitro-сервис `apps/ops/` без UI, деплой на ops.fastio.ru. Telegram notify-хендлеры, cron-триггеры и email-шаблоны выделены из apps/admin и supabase/templates в единое место ответственности.
