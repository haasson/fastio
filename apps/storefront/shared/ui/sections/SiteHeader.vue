...
import HeaderUserMenu from '~/shared/ui/HeaderUserMenu.vue'
import MobileUserCard from '~/shared/ui/MobileUserCard.vue'
import BranchPickerModal from '~/features/branch/components/BranchPickerModal.vue'
