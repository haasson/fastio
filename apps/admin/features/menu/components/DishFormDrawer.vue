...
import { useAddons } from '~/shared/data/useAddons'
import { BasicInfoSection } from '~/features/catalog'
import { TagsSection } from '~/features/catalog'
import DishModifiersSection from './form/DishModifiersSection.vue'
import AddonsSection from './form/AddonsSection.vue'
