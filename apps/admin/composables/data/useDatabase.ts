...
import { appointmentsApi } from '~/utils/api/services/appointments'
import { visitsApi } from '~/utils/api/services/visits'
import { appointmentSettingsApi } from '~/utils/api/services/appointment-settings'
import { appointmentEventsApi } from '~/utils/api/services/appointment-events'
import { servicesApi } from '~/utils/api/services/services'
import { resourcesApi } from '~/utils/api/services/resources'
import { resourceUnavailabilityApi } from '~/utils/api/services/resource-unavailability'
import { scheduleTemplatesApi } from '~/utils/api/services/schedule-templates'
