// Admin Supabase client для serverless-эндпоинтов лендинга.
// Новые Supabase-проекты выпиливают static service_role ключ и выдают JWK для подписи JWT —
// если задан NUXT_SUPABASE_JWT_PRIVATE_KEY (JWK в base64), подписываем ES256-токен на 55 минут;
// иначе fallback на NUXT_SUPABASE_SERVICE_ROLE_KEY (старые проекты).
